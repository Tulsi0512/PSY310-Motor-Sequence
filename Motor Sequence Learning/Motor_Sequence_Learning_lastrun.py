...
expName = 'Motor_Sequence_Learning'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Jash\\Downloads\\PsychoPy\\Motor Sequence Learning\\Motor_Sequence_Learning_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    line1 = visual.Rect(
        ...
        ori=90.0, pos=(-150, 0), draggable=True, anchor='center',
        lineWidth=1.0,
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('sequnce_con.xlsx'), 
        seed=None, 
    )
